  ...
  return (
    <section className="py-24 px-8 max-w-4xl mx-auto">
      <div className="liquid-glass overflow-hidden rounded-sm">
        {/* Terminal title bar */}
        <div className="bg-surface-container-high/60 px-4 py-2 flex items-center gap-2 border-b border-outline-variant/20">
          <div className="flex gap-1.5">
            <div className="w-2.5 h-2.5 rounded-full bg-error" />
            <div className="w-2.5 h-2.5 rounded-full bg-tertiary" />
            <div className="w-2.5 h-2.5 rounded-full bg-secondary" />
          </div>
          <span className="font-mono text-[10px] text-on-surface-variant ml-4 uppercase tracking-widest">
        ...
        <div className="p-8 font-mono text-sm leading-relaxed">
          ...
          <div className="text-on-surface-variant mb-6 pl-4 border-l border-outline-variant/30 space-y-0.5">
            ...
            <div>Role: <span className="text-on-surface">Full Stack Developer @ Entugo Pvt. Ltd.</span></div>
          ...
          <div className="mb-6 pl-4 border-l border-outline-variant/30 space-y-1.5">
            {contactMethods.map((c) => (
              <div key={c.label} className="flex items-center gap-3">
                <span className="text-outline w-20 text-[11px] uppercase tracking-wider">{c.label}</span>
                <a
                  href={c.href}
                  target={c.href.startsWith("http") ? "_blank" : undefined}
                  rel="noopener noreferrer"
                  className={`${c.color} hover:underline underline-offset-2 transition-all`}
                >
                  {c.value}
                </a>
              </div>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <a
              href="mailto:ayushr1606@gmail.com"
              className="bg-primary text-on-primary px-6 py-3 font-bold hover:shadow-[0_0_20px_#81ecff] transition-all uppercase tracking-tighter text-sm"
            >
