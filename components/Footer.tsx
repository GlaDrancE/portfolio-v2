...
export default function Footer() {
  return (
    <footer className="w-full py-12 px-8 mt-20 bg-[#060e20] border-t border-slate-800/50 relative z-10">
      <div className="max-w-screen-2xl mx-auto space-y-6">
        {/* Top row */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-cyan-400 font-bold font-mono text-xl">GladCode//</div>
        ...
        {/* Contact details row */}
        <div className="flex flex-wrap justify-center md:justify-between items-center gap-x-8 gap-y-2 border-t border-slate-800/50 pt-6">
          <a
            href="mailto:ayushr1606@gmail.com"
            className="font-mono text-[11px] text-slate-500 hover:text-cyan-300 transition-colors tracking-wider"
          >
